...
export default async function routeConfigRoutes(fastify) {
   ...
   */
  fastify.post("/route-config", async (request, reply) => {
   ...
   */
  fastify.get("/route-configs", async (request, reply) => {
    // TODO: Add admin authentication check
   ...
   */
  fastify.get("/route-config/:pattern", async (request, reply) => {
    // TODO: Add admin authentication check
   ...
   */
  fastify.post("/set-public-override", async (request, reply) => {
    // TODO: Add admin authentication check
   ...
   */
  fastify.post("/set-disabled", async (request, reply) => {
    // TODO: Add admin authentication check
   ...
   */
  fastify.delete("/route-config/:pattern", async (request, reply) => {
    // TODO: Add admin authentication check
    const { pattern } = request.params;
